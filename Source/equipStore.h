...
public:
	...
	vector<tagEquipInfo*> _vBagEquip;
	vector<tagEquipInfo*>::iterator _viBagEquip;

	vector<tagEquipInfo*> getVBuyEquip() const { return _vBagEquip; }
	void setVBuyEquip(vector<tagEquipInfo*> vBuyEquip) { _vBagEquip = vBuyEquip; }
